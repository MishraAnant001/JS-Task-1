$(document).ready(function () {
    ...
    function loadData(){
        allData.forEach((student)=>{
            table.row.add([`<i class="bi bi-table"></i>`, student.fname,student.lname , student.dob, student.email, student.address,student.gradyear, `<td> <a href="#" class="btn btn-warning btn-sm "><i class="bi bi-pencil-square edit"  data-bs-toggle="modal" data-bs-target="#exampleModal" ></i></a>
